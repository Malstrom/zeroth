...
Каждый фреймворк — одно измерение жизни человека, профессиональной или личной.
...
🏠 **[andrew](../../frameworks/andrew/README.md)** &nbsp;—&nbsp; *«Какой дом я хочу и как к нему прийти?»*
Дом и ремонт своими руками. Проект дома, отличия от текущего состояния, инструменты по домам, проекты с вариантами и оценкой стоимости, учёт каждого потраченного евро — для нескольких домов.
...
│   └── andrew/             # дом и ремонт своими руками — см. README
