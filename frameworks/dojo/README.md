...
Replace `Malstrom/dojo` with the actual instance repo slug.

```
1. Framework manifest: Malstrom/zeroth — frameworks/dojo/.agent.yml. Read it before answering anything.
2. Instance repo: Malstrom/dojo — all workspace paths under "instance:" in the manifest resolve here.
